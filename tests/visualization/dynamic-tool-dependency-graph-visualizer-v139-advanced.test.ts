...
import {
  ...
  ToolUseBlock,
  ThinkingBlock,
} from "../src/visualization/dynamic-tool-dependency-graph-visualizer-v139-advanced";
...
describe("ContentBlock structure", () => {
  ...
  it("should correctly identify a ThinkingBlock", () => {
    const thinkingBlock: ThinkingBlock = {
      type: "thinking",
      thinking: "I am thinking about the next step.",
    };
    expect(thinkingBlock).toHaveProperty("type", "thinking");
    expect(thinkingBlock).toHaveProperty("thinking", "I am thinking about the next step.");
  });
});